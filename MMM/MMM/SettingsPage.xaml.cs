...
namespace MMM
{
    ...
    public sealed partial class SettingsPage : Page
    {
        ...
        public CategoryItem CreateNewCategoryItem()
        {
            ...
            string CategoryRelativePath = "Assets\\" + "CategoryImageStroage\\" + GlobalConfig.SettingCfg.Value.GameName + "\\CategoryImage\\";
        ...
        public CharacterItem CreateNewCharacterItem()
        {
            ...
            string CharacterRelativePath = "Assets\\" + "CategoryImageStroage\\" + GlobalConfig.SettingCfg.Value.GameName + "\\CharacterImage\\";
